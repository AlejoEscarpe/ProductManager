...
- Cree un proyecto de Angular con ng: `ng new ProductManager-UI --defaults --skip-install --skip-git --no-standalone `.
- Actualizar angular.json con puerto.
- Crear archivo de proyecto (`ProductManager-UI.esproj`).
